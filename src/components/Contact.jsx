      ...
      <section className="mx-auto   md:rounded-md hover:md:border md:shadow-lg bg-off bg-opacity-5">
        <div className="grid grid-cols-4   ">
          <div className="col-span-4      px-8 py-10   md:col-span-2 md:border-r md:px-10 md:py-12  ">
            <h2 className="mb-8 text-2xl font-black text-lightish">
              Write me a message
            </h2>
            <ul>
              <li className="mb-6 flex items-start text-left">
                <svg
                  className="shrink-0 mr-6 text-2xl text-lightish "
              ...
              <li className="my-6 flex items-center text-left">
                ...
                <div>
                  <p className="font-serif text-base md:text-lg">nadia-ns11</p>
          ...
          <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
            ...
            <form ref={form} onSubmit={sendEmail}>
              <div className="md:col-gap-4 mb-5 grid md:grid-cols-2">
                <input
                  className="col-span-2 mb-5 rounded w-full border-b bg-olive p-3 text-sm outline-none focus:border-b-2 focus:border-black"
                  type="text"
                  placeholder="Name"
                  name="user_name"
                />
                <input
                  className="col-span-2 w-full border-b mb-5 rounded p-3 text-sm outline-none bg-olive focus:border-b-2 focus:border-black"
                  type="email"
                  placeholder="Email"
                  name="user_email"
                />
              ...
              <textarea
                className="mb-10 w-full resize-y bg bg-olive whitespace-pre-wrap border-b p-3 text-sm outline-none rounded  focus:border-b-2 focus:border-black"
                id=""
                rows="6"
              ...
              <button
                type="submit"
                className="group flex cursor-pointer items-center rounded-xl  border-2 border-lightish   bg-none px-8 py-4 text-center font-semibold leading-tight text-blue-gray-900"
              >
                Send
                <svg
